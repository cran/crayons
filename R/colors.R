...
#' @concept colors
#' @export
crayons <- list(billionth = structure(c(blue_ribbon = "#0B10A2"), class = c(
  "palette",
  "character"
)), color_n_smell = structure(c(
...
), class = c("palette", "character")), colors_of_the_world = structure(c(
  deep_almond = "#986A5A",
...
), class = c("palette", "character")), construction_paper = structure(c(
  "#FFA3B1",
  "#03A9F4", "#795548", "#4848FF", "#FFAD59", "#12E3DB", "#F3715A",
  "#00BCD4", "#F8FC98", "#6A35CE", "#FFE599", "#F37B70", "#B4FFB4",
  "#AA55AA", "#7F7FBF", "#FFFFFF"
), class = c("palette", "character")), fluorescent = structure(c(
...
), class = c("palette", "character")), no_48 = structure(c(
...
), class = c("palette", "character")), no_64 = structure(c(
  red = "#ED0A3F",
  ...
  black = "#000000"
), class = c("palette", "character")), standard16 = structure(c(
  red = "#ED0A3F",
  ...
  black = "#000000"
), class = c("palette", "character")), standard64 = structure(c(
  red = "#ED0A3F",
...
), class = c("palette", "character")), star_brite = structure(c(
